...
public class LandCover extends Application{
    ...
    public LandCover(String country, int startYear, int endYear, String chartType) {
    ...
    public void start(Stage primaryStage) {
        ...
        chart.setTitle("Land Cover in " + country);

        XYChart.Series<String, Number> series = new XYChart.Series<>();
        series.setName("Land Cover");
        ...
        String query = "SELECT SUBSTRING(yearChange, 2) + 0 as year, valueChange " +
                       "FROM landCover WHERE country = '" + country + "' " +
