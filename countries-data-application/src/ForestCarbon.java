...
public class ForestCarbon extends Application{
    ...
    public ForestCarbon(String country, int startYear, int endYear, String chartType) {
    ...
    public void start(Stage primaryStage) {
        ...
        chart.setTitle("Forest Carbon in " + country);

        XYChart.Series<String, Number> series = new XYChart.Series<>();
        series.setName("Forest Carbon");
        ...
        String query = "SELECT SUBSTRING(yearChange, 2) + 0 as year, valueChange " +
                       "FROM forestCarbon WHERE country = '" + country + "' " +
